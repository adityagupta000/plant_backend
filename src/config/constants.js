...
module.exports = {
  ...
  MODEL_CLASSES: (
    ...
    "Healthy,Pest_Fungal,Pest_Bacterial,Pest_Insect,Nutrient_Nitrogen,Nutrient_Potassium,Water_Stress,Not_Plant"
  ).split(","),
  ...
  GUEST_IP_LIMIT: parseInt(process.env.GUEST_IP_LIMIT) || 2, // Per hour
  GUEST_FINGERPRINT_LIMIT: parseInt(process.env.GUEST_FINGERPRINT_LIMIT) || 10, // Per day
  GUEST_SESSION_LIMIT: parseInt(process.env.GUEST_SESSION_LIMIT) || 4, // Per session
  GUEST_PREDICTION_LIMIT: parseInt(process.env.GUEST_PREDICTION_LIMIT) || 10, // Daily limit per IP

  // Time windows
  GUEST_IP_WINDOW_MS: parseInt(process.env.GUEST_IP_WINDOW_MS) || 3600000, // 1 hour
  GUEST_FINGERPRINT_WINDOW_MS:
    parseInt(process.env.GUEST_FINGERPRINT_WINDOW_MS) || 86400000, // 24 hours

  // Suspicious activity thresholds
  GUEST_RAPID_REQUEST_THRESHOLD:
    parseInt(process.env.GUEST_RAPID_REQUEST_THRESHOLD) || 5, // Requests per minute
  GUEST_RAPID_REQUEST_BLOCK_MS:
    parseInt(process.env.GUEST_RAPID_REQUEST_BLOCK_MS) || 900000, // 15 minutes

  // Feature restrictions
  GUEST_MAX_RECOMMENDATIONS:
    parseInt(process.env.GUEST_MAX_RECOMMENDATIONS) || 2,
  GUEST_SHOW_FULL_EXPLANATION:
    process.env.GUEST_SHOW_FULL_EXPLANATION !== "false",
  GUEST_PDF_DOWNLOAD_ENABLED: process.env.GUEST_PDF_DOWNLOAD_ENABLED === "true",

  // ============================================================================
  // PRIVACY SETTINGS
  // ============================================================================

  DEFAULT_STATELESS_MODE: process.env.DEFAULT_STATELESS_MODE !== "false",
  ALLOW_OPTIONAL_LOGIN: process.env.ALLOW_OPTIONAL_LOGIN !== "false",
  ...
  CLEANUP_DELAY_MS: parseInt(process.env.CLEANUP_DELAY_MS) || 10000,
  TEMP_PDF_CLEANUP_DELAY:
    parseInt(process.env.TEMP_PDF_CLEANUP_DELAY) || 300000, // 5 minutes

  // ============================================================================
  // AUTHENTICATED USER LIMITS
  // ============================================================================

  AUTH_DAILY_PREDICTION_LIMIT:
    parseInt(process.env.AUTH_DAILY_PREDICTION_LIMIT) || 50,
  AUTH_HOURLY_PREDICTION_LIMIT:
    parseInt(process.env.AUTH_HOURLY_PREDICTION_LIMIT) || 20,
  ...
  FEATURES: {
    ...
    CLOUD_STORAGE: process.env.CLOUD_STORAGE_ENABLED === "true",
