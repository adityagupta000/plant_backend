...
>>>>>>> Stashed changes
  ...
  // ============================================================================
  // ENHANCED GUEST MODE CONFIGURATION (NEW/UPDATED)
  // ============================================================================

  GUEST_MODE_ENABLED: process.env.GUEST_MODE_ENABLED !== "false", // Default: enabled

  // Multi-layer rate limits
  GUEST_IP_LIMIT: parseInt(process.env.GUEST_IP_LIMIT) || 5, // Per hour
  GUEST_FINGERPRINT_LIMIT: parseInt(process.env.GUEST_FINGERPRINT_LIMIT) || 10, // Per day
  GUEST_SESSION_LIMIT: parseInt(process.env.GUEST_SESSION_LIMIT) || 2, // Per session
  ...
  GUEST_MAX_RECOMMENDATIONS:
    parseInt(process.env.GUEST_MAX_RECOMMENDATIONS) || 2, // Limited recommendations
  GUEST_SHOW_FULL_EXPLANATION:
    process.env.GUEST_SHOW_FULL_EXPLANATION !== "false", // Only for first prediction
  GUEST_PDF_DOWNLOAD_ENABLED: process.env.GUEST_PDF_DOWNLOAD_ENABLED === "true", // Default: disabled
  ...
  // ============================================================================
  // AUTHENTICATED USER LIMITS (for comparison)
  // ============================================================================
...
>>>>>>> Stashed changes
    ...
    // NEW: Guest-specific error codes
